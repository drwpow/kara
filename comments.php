...
<?php if (comments_open()) : ?>
  ...
  <?php else : ?>
    <p><label><?php _e('Name'); if ($req) _e('*'); ?><br>
      <input type="text" name="author" id="comment-name" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "required"; ?>></label></p>
    <p><label><?php _e('Email'); if ($req) _e('*'); ?><br>
      <input type="email" name="email" id="comment-email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req) echo "required"; ?>></label></p>
    <p><label><?php _e('Website'); ?><br>
      <input type="text" name="url" id="comment-url" value="<?php echo  esc_attr($comment_author_url); ?>" size="22" tabindex="3"></label></p>
  <?php endif; ?>
    <textarea name="comment" id="comment-text" tabindex="4"></textarea>
    <p><input name="submit" type="submit" id="comment-submit" tabindex="5" value="<?php esc_attr_e('Submit Comment'); ?>">
